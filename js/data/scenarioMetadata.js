export const SCENARIO_METADATA = {
  mission_first:{
    kind:"mission",accessModel:"legacy",storyStage:"act1",difficulty:"foundation",
  ...
  mission_ghost:{
    kind:"mission",accessModel:"legacy",storyStage:"act1",difficulty:"intermediate",
  ...
  mission_dns:{
    kind:"mission",accessModel:"legacy",storyStage:"act1_to_act2",difficulty:"intermediate",
  ...
  mission_cascade:{
    kind:"mission",accessModel:"legacy",storyStage:"act1_to_act2",difficulty:"advanced",
