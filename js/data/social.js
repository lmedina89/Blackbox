export const SOCIAL_POSTS = [
  {id:"s1",author:"maya_r",name:"Maya",time:"18:03",body:"My internet dropped for ten minutes again. Great.",visibleWhen:[]},
  ...
  {id:"s14",author:"byteghost",name:"byteghost",scheduleId:"ambient_social_byteghost_01",body:"My favorite help-desk ticket genre is 'the internet is down' when one browser tab froze."},
  ...
  {id:"s11",author:"cedar_lane",name:"Cedar Lane",time:"19:26",timeFromEvent:"cedar_lead",body:"My backup server keeps vanishing from scans outside its evening window. CEDAR-NODE / 10.39.7.41 if anyone needs the old lab notes.",visibleWhen:["cedar_lead_available"],clueId:"cedar_home_lab"},
  {id:"s12",author:"maya_r",name:"Maya",time:"20:08",body:"Okay, ThreatDesk actually looks useful. The field notes are way less painful than a manual.",visibleWhen:["threatdesk_online"]},
  {id:"s13",author:"samk91",name:"Sam K.",time:"21:17",body:"Quartz is alive again. Apparently old message boards are immortal.",visibleWhen:["quartz_thread_available"]}
];
