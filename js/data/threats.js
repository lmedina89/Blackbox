export const THREATS=[
  {id:"td_scan",timeFromEvent:"threatdesk_online",title:"Observable does not mean complete",severity:"FIELD NOTE",body:"A discovery scan is a time-bound view from one machine. Quiet systems may be absent, saved systems may remain known, and internal systems still require the correct route.",visibleWhen:["threatdesk_online"]},
  {id:"td_lumen",timeFromEvent:"wider_net_invite",title:"Lumen update alias mismatch",severity:"ADVISORY",body:"Lumen Civic Systems reports that updates.lumen.test briefly followed an unauthorized legacy alias. Resolve the name, preserve the authoritative response, and compare it with the public gateway.",visibleWhen:["lumen_contract_available"],clueId:"lumen_dns_case"},
  {id:"td_iris",timeFromEvent:"iris_contract",title:"Iris overnight heartbeat",severity:"MONITOR",body:"A retired device identifier is still appearing during Iris Transit Cooperative's overnight window. Begin at the public status gateway and follow only routes visible from that machine.",visibleWhen:["iris_contract_available"],clueId:"iris_beacon_case"},
  {id:"td_harbor",timeFromEvent:"harbor_contract",title:"Harbor internal alias review",severity:"CASE",body:"Harbor Mutual requested review of a claims alias that resolves beyond its edge subnet. Their internal resolver should establish the authoritative path.",visibleWhen:["harbor_contract_available"],clueId:"harbor_alias_case"},
  {id:"td_juno",timeFromEvent:"juno_advisory",title:"Juno opens DNS history archive",severity:"REFERENCE",body:"Juno Open Research published a small public archive explaining A, CNAME, MX, and TTL records through fictional examples.",visibleWhen:["juno_advisory_available"],clueId:"juno_archive_host"},
  {id:"td_harbor_close",timeFromEvent:"harbor_public_response",title:"Harbor closes Incident 17",severity:"RESOLVED",body:"Harbor Mutual removed the retired internal alias and preserved its resolver evidence. The company reports no exposure of customer records.",visibleWhen:["harbor_world_updated"]}
];
