...
const SOUNDS={
  ...
  boot_tick(){tone({freq:820,endFreq:760,duration:.035,type:"sine",gain:.055});},
  boot_warn(){tone({freq:330,endFreq:285,duration:.085,type:"sine",gain:.07});tone({freq:245,endFreq:220,duration:.095,delay:.09,type:"sine",gain:.055});},
  intro_ambience(){noise({duration:.42,gain:.010,highpass:180});tone({freq:112,endFreq:118,duration:.72,type:"sine",gain:.020});},
  nexus_ready(){tone({freq:480,endFreq:610,duration:.09,type:"sine",gain:.075});tone({freq:760,endFreq:820,duration:.11,delay:.10,type:"sine",gain:.065});},
