...
export function initDesktopUI({enterBlackbox}){
  ...
  function renderWindow(id,el){
    ({browser:renderBrowser,mail:renderMail,chat:renderChat,files:renderSystem,cmd:renderNexusCommand,missions:renderMissions,servicedesk:renderServiceDesk,notes:renderNotes,threatdesk:renderThreatDesk}[id])?.(el);
  }
  function openApp(id){
