...
import { initServiceDesk, serviceDeskSnapshot, acceptTicket, connectRemote, disconnectRemote, remoteMachineSnapshot, observeRemoteTool, setTicketNotes, setRemoteDevice, setRemoteService, setRemoteGateway, setRemoteFirewallEnabled, setRemoteFirewallRule, renewRemoteDhcp, repairRemoteNetwork, runRemoteCommand, verifyTicket, resolveTicket, escalateTicket } from "../systems/serviceDesk.js";
...
export function initDesktopUI({enterBlackbox}){
  ...
  function renderServiceDesk(el){
    ...
    if(serviceDeskView.mode==="remote"&&snap.remoteSession){
      ...
      const serviceNames={dnsClient:"DNS Client",dhcpClient:"DHCP Client",printSpooler:"Print Spooler",workstation:"Workstation",nexusUpdate:"NEXUS Update"};
