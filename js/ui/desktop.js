...
import { initServiceDesk, serviceDeskSnapshot, acceptTicket, connectRemote, disconnectRemote, remoteMachineSnapshot, observeRemoteTool, setTicketNotes, setRemoteDevice, setRemoteService, setRemoteGateway, setRemoteFirewallEnabled, setRemoteFirewallRule, cleanupRemoteStorage, setRemoteGroupMembership, renewRemoteDhcp, repairRemoteNetwork, runRemoteCommand, verifyTicket, resolveTicket, escalateTicket } from "../systems/serviceDesk.js";
...
export function initDesktopUI({enterBlackbox}){
  ...
  function renderServiceDesk(el){
    ...
    if(serviceDeskView.mode==="remote"&&snap.remoteSession){
      ...
      const remoteStartTools=[["computer","🖥️","My Computer"],["command","⌨️","Command Prompt"],["devices","🔧","Device Manager"],["network","🌐","Network Connections"],["services","⚙️","Services"],["events","📋","Event Viewer"],["access","👥","Users & Groups"],["firewall","🧱","NEXUS Firewall"]];
